...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Ilyas Valiullov"]
  spec.email         = ["ilyas.valiullov@gmail.com"]

  spec.summary       = ""
  spec.description   = "Yabeda adapter to Datadog"
  spec.homepage      = "https://github.com/IlyasValiullov/yabeda-datadog"
  spec.license       = "MIT"
  ...
  spec.add_development_dependency "dogapi", "~> 1.32.0"
end
